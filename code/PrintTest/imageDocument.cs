...
namespace PrintTest
{
    class imageDocument : DocumentBase
    {
        ...
        protected override void OnPrintPage(PrintPageEventArgs eventArgs)
        {
            ...
            Rectangle bestFit = GetBestFitRectangle(eventArgs.MarginBounds, Image.Size);
            eventArgs.Graphics.DrawImage(Image, bestFit);
            eventArgs.Graphics.DrawRectangle(Pens.Black, bestFit);
            eventArgs.Graphics.DrawRectangle(Pens.Black, eventArgs.MarginBounds);
        }
